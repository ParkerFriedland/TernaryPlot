...
unsigned ComponentStructured::CalculateNextWinner(std::vector<ScoreBallot> &ballots, const Outcome &winners, unsigned seats, bool oneSeatPerWinner)
{
	return CalculateNextWinner(ballots, seats);
}

unsigned ComponentStructured::CalculateNextWinner(std::vector<ScoreBallot> &ballots, unsigned seats)
{
